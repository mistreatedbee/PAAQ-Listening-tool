...
import { timeAgo, planBadgeClass, statusBadgeClass } from '@/lib/utils'
        ...
        {loading ? (
          ...
          <div className="py-20 text-center space-y-3">
            ...
            {!search && statusFilter === 'all' && planFilter === 'all' && (
              <Link href="/tenants/new" className="btn btn-primary inline-flex"><Plus className="h-4 w-4" /> Onboard First Company</Link>
            )}
          </div>
        ) : (
              ...
              {filtered.map((t) => (
                ...
                >
                  <td className="px-5 py-3.5">
                    <div>
                      <Link href={`/tenants/${t.id}`} className="font-semibold hover:underline" style={{ color: 'var(--text)' }}>
                        {t.company_name}
                      </Link>
                  ...
                  <td className="px-5 py-3.5">
                    <div className="flex items-center gap-1.5 relative">
                      <Link href={`/tenants/${t.id}`} className="btn btn-ghost p-1.5" title="Open detail">
