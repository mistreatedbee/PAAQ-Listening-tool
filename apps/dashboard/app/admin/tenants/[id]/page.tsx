...
import { planBadgeClass, statusBadgeClass, timeAgo, fmt, maskToken, platformIcon } from '@/lib/admin-utils'
import type { Tenant, TenantProject, TenantUser, AccessToken, Subscription, AuditLogEntry } from '@/lib/admin-types'
import {
...
export default function TenantDetailPage() {
  ...
  if (!tenant) return (
    <div className="space-y-4">
      <Link href="/admin/tenants" className="btn btn-ghost"><ArrowLeft className="h-4 w-4" /> Tenants</Link>
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-3">
          <Link href="/admin/tenants" className="btn btn-ghost p-1.5"><ArrowLeft className="h-4 w-4" /></Link>
          <div
