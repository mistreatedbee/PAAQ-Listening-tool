...
import { PLAN_LIMITS } from '@/lib/admin-types'
import type { SubscriptionPlan, Platform } from '@/lib/admin-types'
import { platformIcon, maskToken } from '@/lib/admin-utils'
import {
      ...
      <div className="admin-card p-6 space-y-5">
        ...
        {step === 'install' && keys && (
          <>
            ...
            <div className="flex gap-3">
              <button className="btn btn-secondary" onClick={() => router.push(`/admin/tenants/${tenantId}`)}>
                View Tenant Detail
              </button>
              <button className="btn btn-primary" onClick={() => router.push('/admin/tenants')}>
                Back to Companies
              </button>
            </div>
          </>
